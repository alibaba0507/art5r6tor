...
//	echo "<br> >>>>>>>>>>>>>>>>>>>>>>> END POST >>>>>>>>>>>>>>>>>>>>>>>>>>><br>";
 try{
	$numbers = 1;//filter_var($_POST['numbers'], FILTER_SANITIZE_SPECIAL_CHARS);
	$keyword= "forex";//filter_var($_POST['keyword'], FILTER_SANITIZE_SPECIAL_CHARS); 
	$_POST['feedsource'] = "google";
