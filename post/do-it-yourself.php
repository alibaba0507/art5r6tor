...
You can either engage the expertise of a Search Engine Optimisation company, or if you have the time, there are some changes you can make to your website yourself.";
  ...
  //include('do-it-yourself.txt.php');
  ?>
...
<li>	Instead of having a link to a different page that says "Click here to read more ", rework it to include your keywords, e.g. "Read more about our <a href= http://www.cleverclicks.com.au/web-copywriting-sales-copywriting-services.php>seo copywriting Services</a>".
</li>
</ul>
<br><br>
